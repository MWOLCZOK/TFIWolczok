<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="GestionarBoletin.aspx.vb" Inherits="Vista.GestionarBoletin" %>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary class">
                    <div class="panel-heading text-center">
                        <asp:Label ID="lblPanelGestionUsuario" runat="server" Text="Gestión de Usuarios" font-size="24px" CssClass="TituloPanel"></asp:Label>
                    </div>
                 </div>
            </div>
                        ...
                        <div class="form-horizontal has-success col-md-12">
                            ...
                            <div class="row">
                             <div class="col-md-3 col-md-offset-1">
                                <asp:Button ClientIDMode="Static" ID="btnAceptar" name="btnAceptar" runat="server" Text="Nuevo" CssClass="btn btn-block btn-success" />
                              </div>
