    ...
    Private Sub btnIngresar_Click(sender As Object, e As EventArgs) Handles btnIngresar.Click
        ...
        Try
            If Page.IsValid = True Then
                ...
                'Dim Bitac As New Bitacora(clienteLogeado, IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraLoginSuccess1").Traduccion & clienteLogeado.NombreUsu & IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraLoginSuccess2").Traduccion, Tipo_Bitacora.Login, Now, Request.UserAgent, Request.UserHostAddress, "", "")
        ...
        Catch Password As Negocio.ExceptionPasswordIncorrecta
            ...
            Me.success.Visible = False
            'Dim Bitac As New Bitacora(Cliente, IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraLoginSuccess1").Traduccion & Cliente.NombreUsu & IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraLoginSuccess3").Traduccion, Tipo_Bitacora.Login, Now, Request.UserAgent, Request.UserHostAddress, "", "")
            'BitacoraBLL.CrearBitacora(Bitac)
        Catch ex As Exception
            'Dim Bitac As New Bitacora(Cliente, ex.Message, Entidades.Tipo_Bitacora.Errores, Now, Request.UserAgent, Request.UserHostAddress, ex.StackTrace, ex.GetType().ToString, Request.Url.ToString)
