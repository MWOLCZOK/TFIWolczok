        ...
        Try
            ...
            If Page.IsValid = True Then
                ...
                If GestorIdioma.ModificarIdioma(IdiomaActual) Then
                    ...
                    'Dim Bitac As New Entidades.Bitacora(clienteLogeado, idiomabitacora.Palabras.Find(Function(p) p.Codigo = "BitacoraModIdiomaSuccess").Traduccion & IdiomaActual.Nombre & ".", Entidades.Tipo_Bitacora.Modificacion, Now, Request.UserAgent, Request.UserHostAddress, "", "")
