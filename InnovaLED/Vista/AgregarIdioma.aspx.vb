        ...
        Try
            ...
            If Page.IsValid = True Then
                ...
                If GestorIdioma.AltaIdioma(Idioma) Then
                    ...
                    'Dim Bitac As New Entidades.Bitacora(clienteLogeado, IdiomaActual.Palabras.Find(Function(p) p.Codigo = "BitacoraAddIdiomaSuccess").Traduccion & Idioma.Nombre & ".", Entidades.Tipo_Bitacora.Alta, Now, Request.UserAgent, Request.UserHostAddress, "", "")
