...
Public Class MaillingBLL
    ...
    Public Shared Sub enviarMailRegistroUsuario(ByVal token As String, ByVal body As String, ByVal ruta As String, ByVal ubicacionserver As String)
        Try
            ...
            Correo.Attachments.Add(New Attachment(ruta & "\remote.png") With {.ContentId = "logo"}) ' Es la imagen del titulo
            Correo.Attachments.Add(New Attachment(ruta & "\knight.png") With {.ContentId = "knight"}) ' Es la imagen deo cuerpo (espadas)
            ...
            Correo.Attachments.Add(New Attachment(ruta & "\youtube-gaming_1200x500.jpg") With {.ContentId = "banner"}) ' Es el banner, medio del mail.
